...
const translations = {
    en: {
        ...
        'about.curriculum.title': 'Curriculum',
        'about.curriculum.text': 'We use the Cambridge curriculum, which is internationally recognized and accredited. Our engaging content links seamlessly with the Cambridge One online platform for homework. Flex English is an accredited Cambridge Center.',
    ...
    vi: {
        ...
        'about.curriculum.title': 'Chương Trình Học',
        'about.curriculum.text': 'Chúng tôi sử dụng giáo trình Cambridge, được quốc tế công nhận và kiểm định. Nội dung hấp dẫn của chúng tôi liên kết trực tuyến với nền tảng Cambridge One cho bài tập về nhà. Flex English là trung tâm Cambridge được kiểm định.',
